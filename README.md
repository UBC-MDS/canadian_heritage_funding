...
To replicate the analysis, install the dependencies listed below, and run the `run_all.sh` at the command line/terminal from the root directory of this project with the following command.  
```$ bash run_all.sh```
